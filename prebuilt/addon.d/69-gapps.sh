...
case "$1" in
  ...
  ;;
  pre-restore)
    # Remove/postinstalle Stock/AOSP apps (from GApps Installer)
    ...
    # Remove/postinstalle 'other' apps (per installer.data)
    ...
    # Remove/postinstalle 'priv-app' apps from 'app' (per installer.data)
    ...
    # Remove/postinstalle 'required' apps (per installer.data)
