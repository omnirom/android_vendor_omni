...
PRODUCT_COPY_FILES += \\
    ...
    \$(LOCAL_PATH)/lib/libwebviewchromium.so:system/app/webview/lib/$ARCH_PREBUILT_CHROMIUM/libwebviewchromium.so \\
    \$(LOCAL_PATH)/app/webview/$ARCH_PREBUILT_CHROMIUM/webview.odex:system/app/webview/$ARCH_PREBUILT_CHROMIUM/webview.odex \\
