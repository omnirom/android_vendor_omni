...
TARGET_SCREEN_DIMENSIONS := $(shell echo $(DEVICE_RESOLUTION) | sed -e 's/x/\n/g')
TARGET_SCREEN_WIDTH := TARGET_SCREEN_DIMENSIONS[0]
TARGET_SCREEN_HEIGHT := TARGET_SCREEN_DIMENSIONS[1]
...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/omni/prebuilt/bootanimation))
...
PRODUCT_COPY_FILES += \
    vendor/omni/prebuilt/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif

# get the default wallpaper depending on screen dimension
ifneq($(DEVICE_RESOLUTION),)
TARGET_SCREEN_HEIGHT := $(shell echo $(DEVICE_RESOLUTION) | sed -e 's/x/\n/g')
TARGET_SCREEN_HEIGHT := TARGET_SCREEN_HEIGHT[1]
$(shell cp vendor/omni/prebuilt/background/$(TARGET_SCREEN_HEIGHT).jpg \
		vendor/omni/overlay/common/frameworks/base/core/res/res/drawable-nodpi/default_wallpaper.jpg)
endif
